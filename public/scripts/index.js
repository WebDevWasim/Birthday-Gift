...
const countdownAudioPlayButton = document.getElementById("countdownAudioPlay");
const countdownAudioPauseButton = document.getElementById(
  "countdownAudioPause"
);
const birthdayAudioPlayButton = document.getElementById("birthdayAudioPlay");
const birthdayAudioPauseButton = document.getElementById("birthdayAudioPause");
const wishingAudioPlayButton = document.getElementById("wishingAudioPlay");
const wishingAudioPauseButton = document.getElementById("wishingAudioPause");
...
x = setInterval(function () {
  ...
  const playCountdownAudio = () => {
    countdownAudioPlayButton.click();
  };

  const playBirthdayAudio = () => {
    countdownAudioPauseButton.click();
    setTimeout(() => {
      birthdayAudioPlayButton.click();
    }, 1000);
  };

  const playWishingAudio = () => {
    birthdayAudioPauseButton.click();
    setTimeout(() => {
      wishingAudioPlayButton.click();
    }, 200);
    setTimeout(() => {
      birthdayAudioPlayButton.click();
    }, 31000);
